...
// Cairns: a few flat stones stacked on high open ground, the way walkers leave
// them. Small, rare by its own place() rule, and with an obstacle, so the flight
// and the camera keep clear of it.
export default defineProp({
  ...
  place(cell) {
    // one cairn in a few cells of the moor and the frost, and only on a local rise
