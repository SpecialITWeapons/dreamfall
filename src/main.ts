...
// The figure, fetched before the world is built because the world takes a
// figure rather than making one. It rides inside the ground's stage rather than
// getting a line of its own: two megabytes off the network and a fifth of a
// second of seam weld and rebind are not something a player needs named.
const avatar = await loadAuthoredFigure();
mark('figure');
